...
-- Volcando datos para la tabla kite_app.reminders: ~25 rows (aproximadamente)
INSERT INTO `reminders` (`id`, `title_id`, `service_id`, `user_id`, `type`, `release_date`, `status`, `created_at`, `updated_at`) VALUES
	...
	(10, 7, 4, 15, 'service', NULL, 1, '2023-12-04 18:45:55', '2023-12-05 02:05:51'),
	...
	(13, 7, NULL, 15, 'release', '2023-12-04 15:46:51', 1, '2023-12-04 18:45:55', '2023-12-05 02:05:50'),
	...
	(26, 67, 1, 15, 'service', NULL, 0, '2023-12-04 21:46:03', '2023-12-04 21:46:03'),
	(27, 67, 2, 15, 'service', NULL, 0, '2023-12-04 21:46:03', '2023-12-04 21:46:03'),
	(28, 67, 3, 15, 'service', NULL, 0, '2023-12-04 21:46:03', '2023-12-04 21:46:03'),
	(29, 67, 4, 15, 'service', NULL, 0, '2023-12-04 21:46:03', '2023-12-04 21:46:03'),
	(30, 67, 5, 15, 'service', NULL, 0, '2023-12-04 21:46:03', '2023-12-04 21:46:03'),
	(31, 67, 6, 15, 'service', NULL, 0, '2023-12-04 21:46:03', '2023-12-04 21:46:03');
...
INSERT INTO `reviews` (`id`, `user_id`, `title_id`, `star_number`, `review_text`, `disabled_at`, `reason`, `created_at`, `updated_at`) VALUES
	...
	(8, 15, 22, 5, 'si', NULL, NULL, '2023-12-05 01:34:24', '2023-12-05 01:34:24'),
	(9, 15, 66, 5, 'test', NULL, NULL, '2023-12-05 01:43:31', '2023-12-05 01:43:31');
...
-- Volcando datos para la tabla kite_app.titles: ~75 rows (aproximadamente)
INSERT INTO `titles` (`id`, `type`, `original_title`, `title`, `year`, `poster_path`, `backdrop_path`, `status`, `overview`, `rating`, `rating_amount`, `origin_country`, `release_date`, `tmdb_id`, `user_id`, `disabled_at`, `reason`, `created_at`, `updated_at`) VALUES
	...
	(67, 'movie', 'Harry Potter and the Prisoner of Azkaban', 'Harry Potter y el prisionero de Azkaban', '2004', '/wF9aoo4YZmpKP4bZPSy4Zwwek6G.jpg', '/obKmfNexgL4ZP5cAmzdL4KbHHYX.jpg', 1, 'Cuando Harry Potter y sus amigos vuelven a Hogwarts para cursar su tercer año de estudios, se ven involucrados en un misterio: de la prisión para magos de Azkaban se ha fugado Sirius Black, un peligroso mago que fue cómplice de Lord Voldemort y que intentará vengarse de Harry Potter. El joven aprendiz de mago contribuyó en gran medida a la condena de Sirius, por lo que hay razones para temer por su vida.', NULL, 0, NULL, '2023-12-04 17:33:59', 'movie/673', NULL, NULL, NULL, '2023-12-04 20:42:45', '2023-12-04 20:42:45'),
...
-- Volcando datos para la tabla kite_app.title_has_genre: ~72 rows (aproximadamente)
...
-- Volcando datos para la tabla kite_app.title_on_service: ~29 rows (aproximadamente)
INSERT INTO `title_on_service` (`id`, `service_id`, `title_id`, `quality`, `link`, `leaving`, `available_since`, `created_at`, `updated_at`) VALUES
	...
	(67, 3, 67, 'uhd', 'https://play.hbomax.com/page/urn:hbo:page:GXssObwqZrVVGwwEAAABI:type:feature', NULL, NULL, '2023-12-04 20:42:47', '2023-12-04 20:42:47'),
...
-- Volcando datos para la tabla kite_app.users: ~14 rows (aproximadamente)
...
INSERT INTO `user_has_title` (`id`, `title_id`, `user_id`, `created_at`, `updated_at`) VALUES
	...
	(4, 67, 15, '2023-12-04 21:45:30', '2023-12-04 21:45:30'),
...
INSERT INTO `user_views_genre` (`id`, `genre_id`, `user_id`, `view_count`, `created_at`, `updated_at`) VALUES
	...
	(17, 12, 15, 8, '2023-12-04 18:37:07', '2023-12-05 06:23:12'),
	...
	(25, 14, 15, 6, '2023-12-04 20:20:42', '2023-12-05 03:25:24'),
...
INSERT INTO `user_views_title` (`id`, `title_id`, `user_id`, `service_id`, `view_count`, `created_at`, `updated_at`) VALUES
	...
	(19, 67, 15, 3, 2, '2023-12-04 20:43:10', '2023-12-04 21:46:25'),
	(20, 46, 15, 3, 2, '2023-12-04 21:36:48', '2023-12-05 03:25:24'),
